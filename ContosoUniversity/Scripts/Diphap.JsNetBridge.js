...
$dp.$JsNet.ContosoUniversity.Models.Student = $dp.$JsNet.ContosoUniversity.Models.Student || function(){ var args = Array.prototype.slice.call(arguments); var obj = {"EnrollmentDate":new Date(),"PersonID":0,"LastName":"","FirstMidName":"","FullName":"","Enrollments":$dp.$JsNet.shared.arrayFactory($dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Enrollment))};obj.constructor=$dp.$JsNet.ContosoUniversity.Models.Student; return obj; };
...
$dp.$JsNet.ContosoUniversity.Models.Instructor = $dp.$JsNet.ContosoUniversity.Models.Instructor || function(){ var args = Array.prototype.slice.call(arguments); var obj = {"HireDate":new Date(),"OfficeAssignment":$dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.OfficeAssignment),"PersonID":0,"LastName":"","FirstMidName":"","FullName":"","Courses":$dp.$JsNet.shared.arrayFactory($dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Course))};obj.constructor=$dp.$JsNet.ContosoUniversity.Models.Instructor; return obj; };
$dp.$JsNet.ContosoUniversity.Models.Course = $dp.$JsNet.ContosoUniversity.Models.Course || function(){ var args = Array.prototype.slice.call(arguments); var obj = {"CourseID":0,"Title":"","Credits":0,"DepartmentID":0,"Enrollments":$dp.$JsNet.shared.arrayFactory($dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Enrollment)),"Instructors":$dp.$JsNet.shared.arrayFactory($dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Instructor)),"Department":$dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Department)};obj.constructor=$dp.$JsNet.ContosoUniversity.Models.Course; return obj; };
$dp.$JsNet.ContosoUniversity.Models.Department = $dp.$JsNet.ContosoUniversity.Models.Department || function(){ var args = Array.prototype.slice.call(arguments); var obj = {"DepartmentID":0,"Name":"","Budget":0,"StartDate":new Date(),"PersonID":0,"RowVersion":$dp.$JsNet.shared.arrayFactory(0),"Administrator":$dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Instructor),"Courses_":$dp.$JsNet.shared.arrayFactory($dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Course)),"Courses":$dp.$JsNet.shared.arrayFactory($dp.shared.circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Course))};obj.constructor=$dp.$JsNet.ContosoUniversity.Models.Department; return obj; };
window.$dp = window.$dp || {};
window.$dp.$JsNet = window.$dp.$JsNet || {};
window.$dp.$JsNet.ContosoUniversity = window.$dp.$JsNet.ContosoUniversity || {};
window.$dp.$JsNet.ContosoUniversity.Models = window.$dp.$JsNet.ContosoUniversity.Models || {};
