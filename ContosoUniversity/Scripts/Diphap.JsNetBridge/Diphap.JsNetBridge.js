...
$dp.$JsNet.ContosoUniversity.Models.Student = $dp.$JsNet.ContosoUniversity.Models.Student || function ()
{
    var args = Array.prototype.slice.call(arguments);
    var obj = {
        "EnrollmentDate": new Date(), "PersonID": 0, "LastName": "", "FirstMidName": "", "FullName": "", "Enrollments":
            $dp.$shared.$arrayFactory($dp.$shared.$circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.ContosoUniversity.Models.Enrollment)),
        "MyModel": $dp.$shared.$circularReferenceManagerFactory.apply(null, args)($dp.$JsNet.TestModels.MyModel)
    }; obj.$stamp = _stampFunc; return obj;
};
