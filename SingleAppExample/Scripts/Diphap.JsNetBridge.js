...
$dp.$JsNet.$UrlSet = {
    ...
    "TodoList": {
        "GetTodoLists":
            function actionFactory() { var action = {}; action.Url = null; action.sig0 = function actionFactory() { var action = {}; action.Params = function () { var obj = null; return obj; }; action.Return = function () { var obj = $dp.shared.arrayFactory({ "TodoListId": 0, "UserId": "", "Title": "", "Todos": $dp.shared.arrayFactory({ "TodoItemId": 0, "Title": "", "IsDone": false, "TodoListId": 0 }) }); return obj; }; action.IsApiController = { methods: { get: "get", items: ["get"], single: "get" } }; action.AjaxOptions = function () { var obj = { dataType: "json", contentType: "application/json", cache: false }; return obj; }; return action; }(); return action; }(),
        "GetTodoList": function actionFactory() { var action = {}; action.Url = null; action.sig0 = function actionFactory() { var action = {}; action.Params = function () { var obj = { "id": 0 }; return obj; }; action.Return = function () { var obj = { "TodoListId": 0, "UserId": "", "Title": "", "Todos": $dp.shared.arrayFactory({ "TodoItemId": 0, "Title": "", "IsDone": false, "TodoListId": 0 }) }; return obj; }; action.IsApiController = { methods: { get: "get", items: ["get"], single: "get" } }; action.AjaxOptions = function () { var obj = { dataType: "json", contentType: "application/json", cache: false }; return obj; }; return action; }(); return action; }(),
        "PutTodoList": function actionFactory() { var action = {}; action.Url = null; action.sig0 = function actionFactory() { var action = {}; action.Params = function () { var obj = { "id": 0, "todoListDto": $dp.$JsNet.SingleAppExample.Models.TodoListDto() }; return obj; }; action.Return = function () { var obj = {}; return obj; }; action.IsApiController = { methods: { put: "put", items: ["put"], single: "put" } }; action.AjaxOptions = function () { var obj = { dataType: "text", contentType: "application/json", cache: false }; return obj; }; return action; }(); return action; }(), "PostTodoList": function actionFactory() { var action = {}; action.Url = null; action.sig0 = function actionFactory() { var action = {}; action.Params = function () { var obj = { "todoListDto": $dp.$JsNet.SingleAppExample.Models.TodoListDto() }; return obj; }; action.Return = function () { var obj = {}; return obj; }; action.IsApiController = { methods: { post: "post", items: ["post"], single: "post" } }; action.AjaxOptions = function () { var obj = { dataType: "text", contentType: "application/json", cache: false }; return obj; }; return action; }(); return action; }(),
        "DeleteTodoList": function actionFactory() { var action = {}; action.Url = null; action.sig0 = function actionFactory() { var action = {}; action.Params = function () { var obj = { "id": 0 }; return obj; }; action.Return = function () { var obj = {}; return obj; }; action.IsApiController = { methods: { delete: "delete", items: ["delete"], single: "delete" } }; action.AjaxOptions = function () { var obj = { dataType: "text", contentType: "application/json", cache: false }; return obj; }; return action; }(); return action; }()
    }
};
