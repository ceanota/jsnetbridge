...
$dp.$JsNet.SingleAppExample.Areas.HelpPage.Models.HelpPageApiModel = $dp.$JsNet.SingleAppExample.Areas.HelpPage.Models.HelpPageApiModel || function () { var obj = { "ErrorMessages": $dp.shared.arrayFactory(""), "ApiDescription": $dp.$JsNet.System.Web.Http.Description.ApiDescription, "SampleRequests": $dp.shared.arrayFactory($dp.$JsNet.System.Net.Http.Headers.MediaTypeHeaderValue), "SampleResponses": $dp.shared.arrayFactory($dp.$JsNet.System.Net.Http.Headers.MediaTypeHeaderValue) }; obj.constructor = $dp.$JsNet.SingleAppExample.Areas.HelpPage.Models.HelpPageApiModel; return obj; };
...
$dp.$JsNet.SingleAppExample.Models.TodoItemDto = $dp.$JsNet.SingleAppExample.Models.TodoItemDto ||
    function () {
        var obj = { "TodoItemId": 0, "Title": "", "IsDone": false, "TodoListId": 0 }; obj.constructor = $dp.$JsNet.SingleAppExample.Models.TodoItemDto; return obj;
    };
$dp.$JsNet.SingleAppExample.Models.TodoItem = $dp.$JsNet.SingleAppExample.Models.TodoItem ||
    function () {
        var obj = {
            "TodoItemId": 0, "Title": "", "IsDone": false, "TodoListId": 0,
            "TodoList": $dp.$JsNet.SingleAppExample.Models.TodoList
        }; obj.constructor = $dp.$JsNet.SingleAppExample.Models.TodoItem; return obj;
    };
$dp.$JsNet.SingleAppExample.Models.TodoList = $dp.$JsNet.SingleAppExample.Models.TodoList ||
    function () {
        var obj = {
            "TodoListId": 0, "UserId": "", "Title": "",
            "Todos": $dp.shared.arrayFactory($dp.$JsNet.SingleAppExample.Models.TodoItem)
        }; obj.constructor = $dp.$JsNet.SingleAppExample.Models.TodoList; return obj;
    };
$dp.$JsNet.SingleAppExample.Models.TodoListDto = $dp.$JsNet.SingleAppExample.Models.TodoListDto ||
    function () {
        var obj = { "TodoListId": 0, "UserId": "", "Title": "", "Todos": $dp.shared.arrayFactory($dp.$JsNet.SingleAppExample.Models.TodoItemDto) };
        obj.constructor = $dp.$JsNet.SingleAppExample.Models.TodoListDto; return obj;
    };
window.$dp = window.$dp || {};
window.$dp.$JsNet = window.$dp.$JsNet || {};
window.$dp.$JsNet.SingleAppExample = window.$dp.$JsNet.SingleAppExample || {};
...
$dp.$JsNet.$UrlSet = {
    "HelpPage": { "Help": { "Index": { Url: null, Params: function () { var obj = null; return obj; }, Return: function () { var obj = {}; return obj; }, IsApiController: null, AjaxOptions: function () { var obj = {}; return obj; } }, "Api": { Url: null, Params: function () { var obj = { "apiId": "" }; return obj; }, Return: function () { var obj = {}; return obj; }, IsApiController: null, AjaxOptions: function () { var obj = {}; return obj; } } } },
