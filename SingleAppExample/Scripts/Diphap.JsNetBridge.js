...
$dp.$JsNet.SingleAppExample.Models.TodoItem = $dp.$JsNet.SingleAppExample.Models.TodoItem || function(){ var obj = {"TodoItemId":0,"Title":"","IsDone":false,"TodoListId":0,"TodoList":};obj.constructor=$dp.$JsNet.SingleAppExample.Models.TodoItem; return obj; };
$dp.$JsNet.SingleAppExample.Models.TodoList = $dp.$JsNet.SingleAppExample.Models.TodoList || function(){ var obj = {"TodoListId":0,"UserId":"","Title":"","Todos":$dp.shared.arrayFactory()};obj.constructor=$dp.$JsNet.SingleAppExample.Models.TodoList; return obj; };
