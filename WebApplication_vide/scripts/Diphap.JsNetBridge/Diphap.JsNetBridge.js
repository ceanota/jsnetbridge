...
_alias0.EffetFacture = _alias0.EffetFacture || function(){ var args = Array.prototype.slice.call(arguments); var obj = {"EffetFactureId":0,"FactureId":0,"DateEcheance":new Date(),"ModeReglementId":0,"Montant":0,"UtilisateurId":0,"DateCreation":new Date(),"DateModif":new Date(),"CreateurId":0,"PointageId":0,"Ecart":false,"EtatId":0,"SessionComptabilisationId":0,"NiveauRelanceId":0,"DateDerniereRelance":new Date(),"NumDoc":"","DateDocument":new Date(),"Pointage":$dp.$shared.$circularReferenceManagerFactory.apply(null, args)(_alias0.Pointage)};obj.constructor=_alias0.EffetFacture; return obj; };
_alias0.Reglement = _alias0.Reglement || function(){ var args = Array.prototype.slice.call(arguments); var obj = {"ReglementId":0,"DossierId":0,"DateReglement":new Date(),"NumReglement":"","ModeReglementId":0,"BanqueId":0,"NumCheque":0,"Emetteur":"","TiersId":0,"Montant":0,"DeviseId":0,"RemisEnBanque":false,"BlocNote":"","UtilisateurId":0,"DateCreation":new Date(),"DateModif":new Date(),"CreateurId":0,"TauxDev":0,"PointageId":0,"EtatId":0,"SessionComptabilisationId":0,"Pointage":$dp.$shared.$circularReferenceManagerFactory.apply(null, args)(_alias0.Pointage)};obj.constructor=_alias0.Reglement; return obj; };
_alias0.Pointage = _alias0.Pointage || function(){ var args = Array.prototype.slice.call(arguments); var obj = {"PointageId":0,"DossierId":0,"TiersId":0,"DatePointage":new Date(),"Lettrage":"","UtilisateurId":0,"DateCreation":new Date(),"DateModif":new Date(),"CreateurId":0,"EffetFacture":$dp.$shared.$arrayFactory($dp.$shared.$circularReferenceManagerFactory.apply(null, args)(_alias0.EffetFacture)),"Reglement":$dp.$shared.$arrayFactory($dp.$shared.$circularReferenceManagerFactory.apply(null, args)(_alias0.Reglement))};obj.constructor=_alias0.Pointage; return obj; };
//#endregion
//#region 'Enum'
window.$dp = window.$dp || {};
$dp.$JsNet = $dp.$JsNet || {};
